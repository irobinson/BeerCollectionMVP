<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BeerCollectionSettings.ascx.cs" Inherits="BeerCollection.BeerCollectionSettings" %>
...
<p>To show the list of beers you can do the following:</p>d
